...
define(function (require, module) {
	...
	var d3mod = require('/static/app/splunktel_demo/custom/d3.v3.min.js');
	...
	return SimpleSplunkView.extend({
		...
		updateView: function (viz, data) {
			var html = '<center>';
			html += '<table style="color: #edcc3a; border-collapse:collapse; border-spacing: 0px; margin-left:auto; margin-right:auto; background-repeat: no-repeat; background-image: url(/static/app/splunktel_demo/end2end.png);">';
			html += '<tr><td colspan="3"><img src="/static/app/splunktel_demo/end2end.png"></td></tr>';
